...
PARAMS = {
    ...
    # G4 支撑建仓闸（2026-08-05 owner决策：回踩支撑+RSI/MACD/BOLL联动+缩量才建仓）
    # TODO(PhaseD): 以下三值为临时定值，寻优前日常复盘只记录不调整
    "entry_rsi_low": 30,
    "entry_rsi_high": 55,
...
STOCK_PARAMS = {
    ...
    # 以下标的沿用全局 PARAMS 默认值，标记为"未适配"
    "600481": {
        "_note": "双良节能 - 未适配，沿用全局默认参数",
        # WP-B22: M2 池闸个股定制——单手 435 元，留 ~8% 余量（amp/amt 沿用全局默认）
    ...
    "603667": {
        "_note": "五洲新春 - 未适配，沿用全局默认参数",
    },
    "300054": {
        "_note": "鼎龙股份 - 未适配，沿用全局默认参数（2026-08-05 入池）",
    },
    "300364": {
        "_note": "中文在线 - 未适配，沿用全局默认参数（2026-08-05 入池）",
    },
    "002639": {
        "_note": "雪人集团 - 未适配，沿用全局默认参数（2026-08-05 入池）",
    },
    "300153": {
        "_note": "科泰电源 - 未适配，沿用全局默认参数（2026-08-05 入池）",
    },
    "300456": {
        "_note": "赛微电子 - 未适配，沿用全局默认参数（2026-08-05 入池）",
    },
    "002202": {
        "_note": "金风科技 - 未适配，沿用全局默认参数（2026-08-05 入池，实盘亏损票）",
    },
    "002536": {
        "_note": "飞龙股份 - 未适配，沿用全局默认参数（2026-08-05 入池，实盘亏损票）",
    },
    "002176": {
        "_note": "江特电机 - 未适配，沿用全局默认参数（2026-08-05 入池，实盘亏损票）",
    },
    "600584": {
        "_note": "长电科技 - 未适配，沿用全局默认参数（2026-08-05 入池，实盘亏损票）",
    },
    "002261": {
        "_note": "拓维信息 - 未适配，沿用全局默认参数（2026-08-05 入池，实盘亏损票）",
    },
    "600089": {
        "_note": "特变电工 - 未适配，沿用全局默认参数（2026-08-05 入池，实盘亏损票）",
    },
    "002451": {
